...
// ========================================
// @desc    Public super-admin registration is disabled during beta
// @route   POST /api/auth/register/super-admin
// @access  Disabled; use the restricted offline operator workflow
export const registerSuperAdmin = betaFeatureUnavailable;
